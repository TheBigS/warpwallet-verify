package warp.wallet.verify.dogecoin;
/**
...
public class VerifyDogecoin {
    ...
    public static void main(String[] args) throws GeneralSecurityException {
        ...
        // BASE-58 Check-Encode private key (Dogecoin's private key version = 0x9e)
        System.out.println("Private Key Encoded : " + Base58.encodeCheckSum(0x9e, privateKey));
    }
